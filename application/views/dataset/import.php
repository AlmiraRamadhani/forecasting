    ...
    <div class="col-md-6">
        <form method="post" enctype="multipart/form-data">
            ...
            if ($_POST) {
                ...
                $row = 0;
                move_uploaded_file($_FILES['dataset']['tmp_name'], 'assets/upload/' . $_FILES['dataset']['name']) or die('Upload gagal');

                $arr = array();

                if (($handle = fopen('assets/upload/' . $_FILES['dataset']['name'], "r")) !== FALSE) {

...
<head>
  ...
  <title>Source Code Forecasting Trend Moment CodeIgniter</title>
  ...
  <nav class="navbar navbar-default navbar-static-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?= site_url() ?>">Trend Moment CI</a>
      </div>
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          <?php if ($this->session->userdata('login')) : ?>
            ...
            <?php endif ?>
            <li><a href="<?= site_url('atribut') ?>"><span class="glyphicon glyphicon-th"></span> Atribut</a></li>
            <li><a href="<?= site_url('dataset') ?>"><span class="glyphicon glyphicon-th"></span> Dataset</a></li>
            <li><a href="<?= site_url('hitung') ?>"><span class="glyphicon glyphicon-stats"></span> Hitung</a></li>
            <li><a href="<?= site_url('transaksi') ?>"><span class="glyphicon glyphicon-stats"></span> Transaksi</a></li>
